...
<body>
    ...
    if ($total >= 80) echo "<img src=image/A.jpg width=100px>";
    elseif ($total >= 70) echo "<img src=image/B.jpg width=100px>";
    elseif ($total >= 60) echo "<img src=image/C.jpg width=100px>";
    elseif ($total >= 50) echo "<img src=image/D.jpg width=100px>";
    else echo "<img src=image/F.jpg width=100px>";
    echo "<br>";
